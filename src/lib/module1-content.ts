...
export const MODULE1_LESSONS: Record<string, LessonContent> = {
  '22222222-0000-0000-0000-000000000101': {
    brief: {
      ...
      body: 'Meet people politely and introduce yourself in French.\n\n**Subject pronouns** identify who acts: *je* (I), *tu* (you, informal), *il/elle* (he/she), *nous* (we), *vous* (you formal or plural), *ils/elles* (they). French verbs change with each pronoun — you normally keep the subject.\n\n**Être** (to be) is irregular: *je suis, tu es, il/elle est, nous sommes, vous êtes, ils/elles sont*. Use it for identity, nationality, profession, and descriptions.\n\nFor your name, say **je m\'appelle** + name. To identify someone: **c\'est** + name (*C\'est Marie*). To describe nationality: **il/elle est** + adjective (*Elle est française*). A common trap: never *c\'est française*.\n\n**Tu vs vous**: *tu* is informal (friends, peers, children). *Vous* is formal (strangers, elders, professionals) or plural. When unsure, start with *vous*.\n\n**Habiter** + *à* + city (*J\'habite à Paris*). Use *en* before feminine countries (*en France*).\n\n**Greetings**: *bonjour* (daytime), *bonsoir* (evening), *salut* (casual). After introductions: *Enchanté(e)*. Essentials: *merci*, *s\'il vous plaît*, *pardon*, *au revoir*, *à bientôt*.',
    ...
    reading: readingParagraphs('c1', [
      ...
      'En France, la politesse est très importante au quotidien. Le matin, on dit « bonjour » à tout le monde : au café, à l\'université, dans la rue. Le soir, on dit « bonsoir ». Avec des amis, on peut dire « salut ». Pour parler à un inconnu ou à un professeur, on utilise « vous » et « s\'il vous plaît ». « Pardon » est aussi très utile.',
      'Pour se présenter, on dit « Je m\'appelle… » ou « Moi, c\'est… » plus un nom. Pour la nationalité, on dit « Je suis français » ou « Elle est française ». Attention : « C\'est Marc » identifie une personne, mais « Il est français » décrit. C\'est une différence très importante en français !',
      'Marc et Marie se rencontrent à Paris un lundi. « Bonjour ! Je m\'appelle Marc. Enchanté », dit Marc. « Salut Marc ! Moi, c\'est Marie. Enchantée », répond Marie. « Tu es française ? » « Oui, je suis française. Et toi ? » « Je suis français. J\'habite à Paris. » « Moi aussi ! Comment ça va ? » « Ça va bien, merci. »',
      'Le soir, Marc dit « Bonsoir » à son ami Paul. Paul est anglais mais il habite en France. « Tu es anglais ? » demande Marc. « Oui, je suis anglais, mais j\'habite à Paris avec plaisir », répond Paul. « Au revoir ! À bientôt ! » disent les amis. En France, on dit souvent « merci » — c\'est la base d\'une bonne conversation.',
      'Dans une classe à Paris, le professeur dit : « Bonjour ! Comment vous appelez-vous ? » Un étudiant répond : « Je m\'appelle Thomas. Je suis anglais. » Une étudiante dit : « Moi, c\'est Sophie. Je suis française. J\'habite à Lyon. » Le professeur dit : « Très bien ! Vous êtes une classe internationale. »',
    ], V),
    conversation: {
      title: 'Meeting Marie',
  ...
  '22222222-0000-0000-0000-000000000102': {
    brief: {
      ...
      body: 'Talk about numbers, the calendar, and age in French.\n\nFrench days are **not capitalized**: *lundi, mardi, mercredi, jeudi, vendredi, samedi, dimanche*. Use *aujourd\'hui* (today), *demain* (tomorrow), *hier* (yesterday), *semaine* (week), *mois* (month), *année* (year).\n\nAge uses **avoir**, never être: *j\'ai vingt ans* = "I am twenty." Never *je suis vingt ans*. The pattern is always **avoir + number + ans**.\n\nNumbers 0–20 are essential: *zéro, un, deux, trois, quatre, cinq, six, sept, huit, neuf, dix, onze, douze, treize, quatorze, quinze, seize, dix-sept, dix-huit, dix-neuf, vingt*. Compound numbers follow the pattern *vingt et un*, *trente-deux*.\n\nTo ask age: **Quel âge as-tu ?** (informal) or **Quel âge avez-vous ?** (formal). To say when something happens: *Mon anniversaire est vendredi* (no *le* before the day in this pattern).\n\n*Cette semaine* = this week. *La semaine prochaine* = next week. Days with *on* + day: *On se voit samedi ?*',
    ...
    reading: readingParagraphs('c2', [
      ...
      'Marc a vingt ans. Marie a vingt ans aussi. Son anniversaire est vendredi. « Joyeux anniversaire ! » disent les amis. En France, on dit toujours « J\'ai … ans » pour l\'âge : « J\'ai quinze ans », « Elle a trente ans », « Nous avons dix-huit ans ».',
      'Les jours de la semaine sont importants pour organiser la vie. Lundi, mardi, mercredi, jeudi et vendredi sont les jours de travail ou d\'école. Samedi et dimanche sont le week-end. « On se voit samedi ? » demande Marc. « Oui, samedi à dix heures », répond Marie.',
      'Les nombres servent partout : l\'âge, l\'heure, l\'argent. Marc a dix euros. Un café coûte deux euros et un croissant coûte un euro cinquante. « Combien ça coûte ? » demande un touriste. « Ça coûte trois euros », répond le serveur.',
      'Chaque mois a environ trente jours. Une année a douze mois et cinquante-deux semaines. « Quel jour sommes-nous ? » « Nous sommes lundi. » « Quelle heure est-il ? » « Il est midi. » Ces questions sont très utiles au quotidien.',
      'Marie planifie sa semaine : lundi et mercredi, elle a des cours. Mardi, elle va au café avec Marc. Jeudi, elle étudie à la maison. Vendredi, c\'est son anniversaire — une fête avec sa famille ! Samedi, elle se repose. Dimanche, elle prépare la semaine prochaine.',
    ], V),
    conversation: {
  ...
  '22222222-0000-0000-0000-000000000103': {
    brief: {
      ...
      body: 'Order food and drink politely at a French café.\n\n**Je prends** and **je voudrais** are natural for ordering. Countable items take *un/une*: *un café, une eau*. Unspecified amounts use partitives: *du* (m.), *de la* (f.), *de l\'* (vowel): *du thé, de l\'eau, du sucre*.\n\nKey verbs: **prendre** (to have/take), **vouloir** (to want), **aimer** (to like), **payer** (to pay), **commander** (to order), **manger** (to eat), **boire** (to drink).\n\nAt a café, the waiter may ask **Vous désirez ?** (What would you like?). Reply with your order + **s\'il vous plaît**. To pay: **L\'addition, s\'il vous plaît**.\n\n**Silent final consonants**: the -s in *vous voulez* and the -t in *ils prennent* are usually silent. Spelling still matters — learners often forget the silent letters.\n\nRegister tip: use *vous* with staff unless invited to use *tu*. *Merci*, *de rien*, and *au revoir* complete polite exchanges. Tipping is appreciated but not obligatory like in some countries.',
      ruleSlugs: ["articles-partitives","er-present","silent-final-consonants"],
    },
    reading: readingParagraphs('c3', [
      'Au café du coin, Marc et Marie s\'installent à la terrasse. Il est dix heures du matin. Le serveur arrive : « Bonjour ! Vous désirez ? » Marc répond : « Je prends un café et un croissant, s\'il vous plaît. » Marie dit : « Pour moi, un thé et de l\'eau, s\'il vous plaît. »',
      ...
      'À la table voisine, un couple commande deux cafés et du jus d\'orange. « Combien ça coûte ? » demande l\'homme. « Ça coûte huit euros », répond la serveuse. « Je paie », dit la femme. Elle donne dix euros. « Merci. De rien », dit la serveuse.',
      'Marc regarde le menu : café, thé, chocolat chaud, eau, jus, croissant, pain. « Tu veux un chocolat chaud ? » demande Marc. « Non, je prends du thé », répond Marie. « Moi, je prends un café. J\'aime le café français. »',
      'Après le petit-déjeuner, Marc dit : « L\'addition, s\'il vous plaît. » Le serveur apporte l\'addition : quatre euros cinquante pour Marc, trois euros pour Marie. Marc paie avec une carte. « Merci beaucoup ! » « De rien. Au revoir ! »',
  ...
  '22222222-0000-0000-0000-000000000104': {
    brief: {
      ...
      body: 'Describe your family with possessive adjectives.\n\nPossessives agree with the **thing owned**, not the owner:\n- *mon* + masculine singular (*mon frère, mon père*)\n- *ma* + feminine singular (*ma sœur, ma mère*)\n- *mes* + plural (*mes parents, mes frères*)\n\nAlso: *ton/ta/tes* (your informal), *son/sa/ses* (his/her).\n\nUse **avoir** for family members: *j\'ai un frère*, *elle a deux sœurs*. Use **être** for descriptions: *mon père est grand*, *ma sœur est jeune*.\n\nKinship nouns: *père, mère, frère, sœur, fils, fille, parents, enfant, grand-père, grand-mère, oncle, tante, cousin, cousine, mari, femme* (wife).\n\n*Famille* is feminine. *Parents* is plural masculine but means both parents. To ask: **Tu as des frères et sœurs ?** or **Comment s\'appelle ta sœur ?**\n\nExtended family: *grand-père, grand-mère, oncle, tante, cousin, cousine*. Use *chez* for "at someone\'s home": *chez mes parents*. *Son/sa/ses* means his/her — the form follows the noun, not the owner.',
    ...
    reading: readingParagraphs('c4', [
      ...
      'Pour parler de la famille en français, on utilise souvent « avoir » : « J\'ai un frère », « Elle a deux enfants », « Nous avons une grande famille ». On utilise « être » pour décrire : « Mon père est grand », « Ma mère est française ». C\'est simple et très utile !',
    ], V),
    conversation: {
